...
const yogaBeginnerSeatSchema = new mongoose.Schema(
  {
    ...
    usdFee: {
      type: String,
      required: [true, "USD fee is required"],
      trim: true,
    },
    inrFee: {
      type: String,
      required: [true, "INR fee is required"],
      trim: true,
    },

    dormPrice: {
      type: Number,
      required: [true, "USD dorm price is required"],
      min: 0,
    },
    inrDormPrice: {
      type: Number,
      required: [true, "INR dorm price is required"],
      min: 0,
    },

    twinPrice: {
      type: Number,
      required: [true, "USD twin price is required"],
      min: 0,
    },
    inrTwinPrice: {
      type: Number,
      required: [true, "INR twin price is required"],
      min: 0,
    },

    privatePrice: {
      type: Number,
      required: [true, "USD private price is required"],
      min: 0,
    },
    inrPrivatePrice: {
      type: Number,
      required: [true, "INR private price is required"],
      min: 0,
    },
